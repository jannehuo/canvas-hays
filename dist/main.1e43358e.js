...
function () {
  ...
  _createClass(Particle, [{
    ...
    value: function resume() {
      var relativeToDefault = this.getRelativeTo({
        x: this.x0,
        y: this.y0
      }, this);
      var distance = this.getDistance(relativeToDefault);
      var direction = this.getDirection(relativeToDefault, distance);
...
/*#__PURE__*/
function () {
  function HayField(size) {
    _classCallCheck(this, HayField);
  ...
  _createClass(HayField, [{
    key: "createHays",
    value: function createHays() {
      var _this = this;

      _lodash.default.times(this.size, function (i) {
        _this.hays.push(new Particle(i, screen.w / 2, screen.h / 2));
      });
    }
  }, {
    key: "draw",
...
var hayField = new HayField(amount);
animate();
